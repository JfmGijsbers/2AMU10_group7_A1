from team7_A6.auxiliary import coo2ind, box2coo
...
def check_hidden(arr: List[List[int, List[Tuple[int, int]], List[Set[int]]]], r: int) -> List[
...
def prune_hidden(little_num: List[Set[int]], arr: List[Tuple[Tuple[int, int], Set[int]]], m: int, n: int, r: int) -> \
        List[Set[int]]:
    """
