...
class SudokuAI(object):
    ...
    def save(self, object):
        ...
        print('Saving data took {} seconds and {} milliseconds'.format(math.floor(duration.total_seconds()),
    ...
    def load(self):
        ...
        with open(load_path, 'rb') as handle:
            ...
            end_time = datetime.now()
            duration = end_time - start_time
            print('Loading data took {} seconds and {} milliseconds'.format(math.floor(duration.total_seconds()),
                                                                            round(duration.microseconds / 1000)))
        if self.lock:
            self.lock.release()
        return contents
